...
function changedPaths(sha) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4, execa("git", ["show", "-m", "--name-only", "--pretty=format:", "--first-parent", sha])];
                case 1:
                    result = _a.sent();
                    return [2, result.stdout.split("\n")];
            }
        });
    });
}
...
function listCommits(from, to) {
    ...
    return execa
        ...
        var summary = parts[2];
        var date = parts[3];
        return { sha: sha, refName: refName, summary: summary, date: date };
    });
}
