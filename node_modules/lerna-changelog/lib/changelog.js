...
var Git = require("./git");
var github_api_1 = require("./github-api");
...
var Changelog = (function () {
    ...
    Changelog.prototype.createMarkdown = function (options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var from, _a, to, releases;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        from = _a;
                        to = options.tagTo || "HEAD";
                        return [4, this.listReleases(from, to)];
                    case 3:
                        releases = _b.sent();
    ...
    Changelog.prototype.getCommitInfos = function (from, to) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        commits = this.getListOfCommits(from, to);
                        commitInfos = this.toCommitInfos(commits);
    ...
    Changelog.prototype.listReleases = function (from, to) {
        return __awaiter(this, void 0, void 0, function () {
            var commits, releases;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.getCommitInfos(from, to)];
                    case 1:
                        commits = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1: return [2, (_a.sent())
                            .map(function (path) { return _this.packageFromPath(path); })
                            .filter(Boolean)
                            .filter(onlyUnique)];
                }
            });
    ...
    Changelog.prototype.packageFromPath = function (path) {
    ...
    Changelog.prototype.getListOfCommits = function (from, to) {
    ...
    Changelog.prototype.toCommitInfos = function (commits) {
        return commits.map(function (commit) {
            ...
            var tagsInCommit;
            if (refName.length > 1) {
                var TAG_PREFIX_1 = "tag: ";
                tagsInCommit = refName
                    .split(", ")
                    .filter(function (ref) { return ref.startsWith(TAG_PREFIX_1); })
                    .map(function (ref) { return ref.substr(TAG_PREFIX_1.length); });
            }
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            _a = commitInfo;
                                            return [4, this.github.getIssueData(this.config.repo, commitInfo.issueNumber)];
                                        case 1:
