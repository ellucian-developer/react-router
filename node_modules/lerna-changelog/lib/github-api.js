...
var GithubAPI = (function () {
    ...
    GithubAPI.prototype.getBaseIssueUrl = function (repo) {
        return "https://github.com/" + repo + "/issues/";
    };
    GithubAPI.prototype.getIssueData = function (repo, issue) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this._fetch("https://api.github.com/repos/" + repo + "/issues/" + issue)];
            });
        });
    };
    GithubAPI.prototype.getUserData = function (login) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this._fetch("https://api.github.com/users/" + login)];
            });
        });
    };
    GithubAPI.prototype._fetch = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, fetch_1.default(url, {
